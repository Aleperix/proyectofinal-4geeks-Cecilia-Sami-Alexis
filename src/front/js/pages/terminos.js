    ...
    return (
        ...
        <div className="container mt-5 bg-light">
            ...
            <div className="pt-4">
                ...
                <p> La Plataforma permite a los Usuarios publicar y ver un resumen de los Anuncios de coche compartido e interactuar entre ellos para reservar una Plaza. Es posible ver un resumen de los Anuncios sin estar registrado en la Plataforma. No obstante, no podrás: publicar un Anuncio de coche compartido, ver datos del conductor, ni reservar una Plaza sin haber creado primero una Cuenta para convertirte en Usuario.</p>
                ...
                <p> En caso de que te registres utilizando un correo electrónico, te comprometes a guardar en secreto la contraseña seleccionada durante la creación de tu Cuenta y a no comunicársela a ninguna otra persona. En caso de pérdida o divulgación de tu contraseña, deberás comunicárselo a Fromtony inmediatamente. Tú eres el único responsable del uso de tu Cuenta por parte de terceras partes, salvo que hayas comunicado de forma expresa a Fromtony la pérdida, el uso fraudulento por parte de un tercero, o la revelación de tu contraseña a un tercero.</p>
            ...
            <div className="pt-4">
			    ...
			    <p> Fromtony podrá, con fines de transparencia, de mejora de la veracidad o de prevención o detección de fraude, establecer un sistema para verificar parte de la información proporcionada en tu perfil. Se trata, fundamentalmente, de aquellos casos en los que introduces tu número de teléfono o nos proporcionas un Documento de Identidad.</p>
